...
unsafe extern "C" fn levenshtein(_self: *mut pyo3::ffi::PyObject,
								 _args: *mut pyo3::ffi::PyObject) -> *mut pyo3::ffi::PyObject {
...
fn __pyo3_levenshtein(py: pyo3::Python) -> pyo3::PyObject {
	...
	let function =
		unsafe {
			pyo3::PyObject::from_owned_ptr_or_panic(py,
													pyo3::ffi::PyCFunction_New(Box::into_raw(Box::new(_def)),
																			   ::std::ptr::null_mut()))
		};
	function
}
